...
import 'package:cined/productdetails.dart';
import 'package:cined/widgets/navigationdrawer.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: Image(image: AssetImage('images/1200px-Flag_of_the_United_Kingdom__2-3_.svg_-_Copy-removebg-preview.png'),),
        ),
        title: Container(
          height: 38,
          ...
          children: [
            ...
            Container(
              ...
              child: Carousel(
                ...
                images: [
                  AssetImage('images/black-friday-banner-monochrome-illustration-260nw-2010450404.png'),
                  AssetImage('images/sale-banner-template-design-geometric-600w-2007007922.png'),
                  AssetImage('images/big-sale-cashback-discount-offer-600w-705625729.png'),
                ],
              ),
            ),
            //slider section end
